		...
		<div class="row">
			<div class="ten columns form-container">
				...
				<div class="form-extra">
					...
					<div class="form-item">
						<label for="relationOption">Map options</label>
						<select id="relationOption" class="map-search-control">
							<option value="initial">Show all places on map</option>
							<option value="birth">Show birth places on map</option>
							<option value="death">Show death places on map</option>
						</select>
					</div>
